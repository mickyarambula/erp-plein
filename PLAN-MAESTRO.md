...
**Actualización más reciente: 2026-08-09, post-autosuficiencia (E102-E106 + D-138/D-139).** Plan de "autosuficiencia" **CERRADO Y DESPLEGADO** — objetivo: captura + catálogos operables 100% desde el sistema, sin depender del chat de backend. **Tema 2 (D-120..124):** línea de proyecto (`fn_ajustar_linea_proyecto`) + aportación de socio genérica (`fn_registrar_aportacion_socio`, 3 naturalezas) + origen de fondeo en anticipo + `v_deuda_socios`; Miguel ya opera esto solo. **P1 (D-125..128):** Directorio autosuficiente (`recibe_pagos` + rastro de captura, `v_directorio_contrapartes`). **P2 (D-129..132):** Conceptos de costo y Cuentas (banco/virtual) autoservibles. **Fase 1 (D-133):** puerta única "+ Registrar" en Tesorería + `fn_traspaso` saneado. **Fase 2a/2b (D-134/135):** Categorías de deducción y de gasto autoservibles. **Fase 2c (D-136/137):** editar productos/variedades + permisos unificados a `capturar` — **confirmado en producción por Miguel** (capturas de pantalla). **Fase 3:** moneda centralizada (`ERP.MONEDAS`), enums de sistema confirmados. **Cierre post-plan: D-138** (Tema 1 — vista `v_carga_contrapartes`, "Aplicar a carga" en Tesorería filtra por ID en vez de por nombre, cubre proveedores de servicio como flete/comisión) y **D-139** (`fn_alta_producto` consolidada a una sola firma, corrige aviso de "parecido" que nunca se mostraba). Backlog de liquidación bajó de $54,224.70/11 cargas a **$44,224.70/10 cargas** (Cornejos P-043 ya liquidado). Anclas cierre: CxC 565,985.13 · CxP 526,469.78 · Cuadre 0.00 · seg 0/0/0 · JPM 46,808.54 · cargas 85 · folio_max 400. Detalle completo en `PENDIENTES-BACKEND.md`/`MAPA-CAPTURA.md`/`NORTE.md`. Ver BITACORA D-120..D-139.
...
2. Liquidar el backlog (4 prod, 10 cargas, $44,224.70 — Cornejos P-043 ya liquidado), revisando cada borrador.
...
6. Liquidar backlog (4 prod/10 cargas/$44,224.70 — Cornejos P-043 ya liquidado). 7. A-07 notas Samuel P-071/P-075.
